...
$query="update  userRegistration set id_no=?,firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$id_no,$fname,$mname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="id_no" id="id_no"  class="form-control" required="required" value="<?php echo $row->id_no;?>" >
</div>
</div>
