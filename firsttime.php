...
$rc=$stmt->bind_param('ssi',$email,$updationDate,$aid);
$stmt->execute();
...
$chngpwd1->bind_param('sss',$np,$updationDate,$ai);
  $chngpwd1->execute();
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">New profile details</div>
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													Registration date can't be changed.</span> </div>
											</div>
											<div class="form-group">
...
<div class="form-group">
									...
									<div class="col-sm-10">
									<input type="text" value="<?php echo $row->firstName ;?>" disabled class="form-control"><span class="help-block m-b-none">
												</div>
											</div>
